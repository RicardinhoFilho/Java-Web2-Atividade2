...
public class CadastrarUsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
          ...
          usuariosClass.addUsuario(new Usuario(user, login, password));
          

           
            if (user.length() == 0 || login.length() == 0 || password.length() == 0) {
                ...
                out.println("<h1>Não foi possível cadastrar o usuário!</h1>");
                out.println("</div>");
                ...
                out.println("<h1> " + user + " foi adicionado com sucesso!</h1>");
                out.println("</div>");
                out.println("<a href=\"PortalServlet\">Voltar ao Portal</a>");
                out.println("</body>");
                out.println("</html>");
